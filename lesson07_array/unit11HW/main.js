...
function f4() {
    let ar4 = document.querySelector('.i-4').value;
    d1.push(ar4);
    showArr('.out-4', d1);
}
...
function f5() {
    let ar5 = document.querySelector('.i-5').value;
    d1.unshift(ar5);
    showArr('.out-5', d1);
}
...
function f6() {
    let ar6 = document.querySelector('.i-6').value;
    d6[d6.length] = ar6;
...
function f12() {
    let ar12 = +document.querySelector('.i-12').value;
    let out = -1;
...
function f14() {
    let ar14 = +document.querySelector('.i-14').value;
    for (let i = 0; i < ar14; i++) {
        d14[d14.length] = 1;
    }
...
function f18() {
    let ar18 = document.querySelector('.i-18').value;
    let out18 = " ";
    if (d18.includes(ar18)){
        out18 = d18.includes(ar18)
    }else {
        out18 = d18.includes(ar18)
    }
