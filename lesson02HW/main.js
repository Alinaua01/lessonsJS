...
let e1 = '3';
let f1 = '5';
 document.querySelector('.out-4').textContent = e1 + f1;  //(додаємо string)
...
function t8() {
    // value всегда получаем внутри функции
     let a = document.querySelector('.i-8').value; // получили значение
     document.querySelector('.out-8').innerHTML = a;// тут выводим
}
...
function t9() {
    let a1 = document.querySelector('.i-9').value;
    document.querySelector('.out-9').innerHTML = a1;
...
function t10() {
    let a2 = document.querySelector('.i-10').value;
    document.querySelector('.out-10').innerHTML = a2*20;
}
...
function t11() {
    let a3 = document.querySelector('.i-11').value;
    document.querySelector('.out-11').innerHTML = +a3+55;
}
...
function t12() {
    let a4 = document.querySelector('.i-12-1').value;
    let a5 = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').innerHTML = `Hello ${a4} ${a5}`;
}
...
function t14() {
    let c1 = document.querySelector('.i-14').value;
...
function t15() {
    let c2 = document.querySelector('.i-15').value;
...
function t16() {
    let d1 = document.querySelector('.i-16-1').value;
    let d2 = document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').innerHTML = d1 + d2;
}
...
function t19() {
    let k1 = document.querySelector('.i-19-1').value;
    let k2 = document.querySelector('.i-19-2').value;
    document.querySelector('.out-19').innerHTML = +k1 + +k2;
}
